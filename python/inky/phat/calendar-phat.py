...
print("""Inky WHAT: Calendar

Draws a calendar for the current month to your Inky WHAT.
...
#img = Image.open("resources/empty-backdropwhat3.png")
img = Image.open("resources/boder_for_inky_what2.png")
w, h = img.size
print(w)
print(h)
...
# Display the completed calendar on Inky WHAT
w, h = img.size
print(w)
print(h)
