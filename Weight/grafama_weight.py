...
class EventProcessor:
    ...
    def mass(self, event):
        ...
        if (event.totalWeight > 2 and self._measureCnt < WEIGHT_SAMPLES):
            ...
            if self._measureCnt == WEIGHT_SAMPLES:
                ...
                data = {}
                data['measurement'] = 'Krishna_Weight'
                fields = {}
                fields['Weight'] = self._weight
                data['fields'] = fields
                j = [data]
                print(j)
...
class Wiiboard:
    ...
    def send(self, data):
        ...
        self.controlsocket.send(codecs.decode(senddata,"hex"))
