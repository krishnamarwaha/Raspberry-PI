...
PIXEL_COUNT = 64        # Number of LED pixels.
  ...
  try:
    while True:
      ...
      if command == "init":
        ...
        if DEBUG:
          print(">> Initializing RGB strip...")
        pixels = PixelStrip(PIXEL_COUNT, LED_PIN, LED_FREQ_HZ, LED_DMA, LED_INVERT, LED_BRIGHTNESS, LED_CHANNEL)
        pixels.begin()
